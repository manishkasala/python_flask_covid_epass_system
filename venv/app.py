...
account_sid = 'ACdb45023b95a46445094978293a733c01'
auth_token = 'db594eedf322afd8e61d4970c6922778'
...
def login_registration_dtls():
    ...
    if travel_pass < 30 and request.method == 'POST':
        ...
        client.messages.create(to="whatsapp:+918019273837",
                               from_="whatsapp:+14155238886",
                               body="Hello " + " " + full_name + " " + "Yours Travel From" + " " + source_dt + " " +
                                    "To" + " " + destination_dt + " "
                                    + "Has" + " " + status + "On" + " " + date + " " + " ,Apply later")

        return render_template('user_registration_dtls.html', var=full_name, vari=email_id, var2=id_proof,
                               var3=source_st, var4=source_dt, var5=destination_st, var6=destination_dt,
                               var7=phoneNumber, var8=date, var9=status)
